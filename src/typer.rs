...
impl Typer {
    ...
    fn lookup_identifier(
        ...
        let namespace_id = namespace_id.unwrap_or(GLOBAL_NAMESPACE_ID);
        ...
        if let Some(type_kind_id) = self.namespaces[namespace_id].type_kinds.get(&identifier) {
            return Some((
                typed_name,
                Type {
